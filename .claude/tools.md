...
- **Shift** while dragging snaps the cut line to the nearest 15° angle from the drag start point (same `snapToAngle` helper from `core/math.js` used by the path tool)
