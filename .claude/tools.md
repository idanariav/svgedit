...
- `<se-repeat-settings>` popover buttons: `tool_repeat` (Object section, after the offset popover) + `tool_repeat_multi` (Combine section). Popover: Radial (copies 1–36, sweep°, center = canvas/selection) or Grid (rows, cols, gap X/Y)
