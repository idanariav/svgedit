export default {
  ...
  tools: {
    ...
    editor_homepage: 'صفحة Sketch Editor الرئيسية',
  ...
  notification: {
    ...
    editorPreferencesMsg: 'افتراضيًا وحيثما يدعم الأمر، يمكن لـ Sketch Editor تخزين تفضيلات المحرر ومحتوى SVG محليًا على جهازك بحيث لا يلزمك إضافة هذه المحتويات كل مرة تحمل فيها Sketch Editor. إذا لم ترغب لأسباب الخصوصية في تخزين هذه المعلومات على جهازك، فيمكنك التغيير بعيدًا عن الخيار الافتراضي أدناه.',
