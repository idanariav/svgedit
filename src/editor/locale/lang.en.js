export default {
  ...
  hotkeys: {
    ...
    transform_again: 'Transform again (repeat duplicate+move)',
  ...
  tools: {
    ...
    image_crop_apply: 'Apply Crop',
    image_crop_cancel: 'Cancel Crop',
    image_crop_error: 'Could not crop this image.',
